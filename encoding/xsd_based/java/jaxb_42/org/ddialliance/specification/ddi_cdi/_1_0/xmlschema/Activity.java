 ...
 *         <element name="entityProduced" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 ...
 *           </complexType>
 *         </element>
 *         <element name="entityUsed" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/}Reference">
 *                 <sequence>
 ...
 *         <element name="standardModelMapping" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/}Reference">
 *                 <sequence>
...
public class Activity {
    ...
    protected List<Activity.EntityProduced> entityProduced;
    protected List<Activity.EntityUsed> entityUsed;
    protected Identifier identifier;
    protected List<ObjectName> name;
    protected List<Activity.StandardModelMapping> standardModelMapping;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Activity.EntityProduced }
     * 
     * 
     * @return
     *     The value of the entityProduced property.
     */
    public List<Activity.EntityProduced> getEntityProduced() {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Activity.EntityUsed }
     * 
     * 
     * @return
     *     The value of the entityUsed property.
     */
    public List<Activity.EntityUsed> getEntityUsed() {
        if (entityUsed == null) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Activity.StandardModelMapping }
     * 
     * 
     * @return
     *     The value of the standardModelMapping property.
     */
    public List<Activity.StandardModelMapping> getStandardModelMapping() {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class EntityProduced
        extends Reference
    {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class EntityUsed
        extends Reference
    {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StandardModelMapping
        extends Reference
    {
