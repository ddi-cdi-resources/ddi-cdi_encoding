...
public interface Activity extends org.apache.xmlbeans.XmlObject {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "activityad6dtype");
     ...
     */
    java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityProduced> getEntityProducedList();

    /**
     * Gets array of all "entityProduced" elements
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityProduced[] getEntityProducedArray();

    /**
     * Gets ith "entityProduced" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityProduced getEntityProducedArray(int i);
     ...
     */
    void setEntityProducedArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityProduced[] entityProducedArray);

    /**
     * Sets ith "entityProduced" element
     */
    void setEntityProducedArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityProduced entityProduced);

    /**
     * Inserts and returns a new empty value (as xml) as the ith "entityProduced" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityProduced insertNewEntityProduced(int i);

    /**
     * Appends and returns a new empty value (as xml) as the last "entityProduced" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityProduced addNewEntityProduced();
     ...
     */
    java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityUsed> getEntityUsedList();

    /**
     * Gets array of all "entityUsed" elements
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityUsed[] getEntityUsedArray();

    /**
     * Gets ith "entityUsed" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityUsed getEntityUsedArray(int i);
     ...
     */
    void setEntityUsedArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityUsed[] entityUsedArray);

    /**
     * Sets ith "entityUsed" element
     */
    void setEntityUsedArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityUsed entityUsed);

    /**
     * Inserts and returns a new empty value (as xml) as the ith "entityUsed" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityUsed insertNewEntityUsed(int i);

    /**
     * Appends and returns a new empty value (as xml) as the last "entityUsed" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityUsed addNewEntityUsed();
     ...
     */
    java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.StandardModelMapping> getStandardModelMappingList();

    /**
     * Gets array of all "standardModelMapping" elements
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.StandardModelMapping[] getStandardModelMappingArray();

    /**
     * Gets ith "standardModelMapping" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.StandardModelMapping getStandardModelMappingArray(int i);
     ...
     */
    void setStandardModelMappingArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.StandardModelMapping[] standardModelMappingArray);

    /**
     * Sets ith "standardModelMapping" element
     */
    void setStandardModelMappingArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.StandardModelMapping standardModelMapping);

    /**
     * Inserts and returns a new empty value (as xml) as the ith "standardModelMapping" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.StandardModelMapping insertNewStandardModelMapping(int i);

    /**
     * Appends and returns a new empty value (as xml) as the last "standardModelMapping" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.StandardModelMapping addNewStandardModelMapping();
     ...
     * This is a complex type.
     */
    public interface EntityProduced extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityProduced> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "entityproduced64eaelemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
     ...
     * This is a complex type.
     */
    public interface EntityUsed extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.EntityUsed> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "entityusedd911elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
     ...
     * This is a complex type.
     */
    public interface StandardModelMapping extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.StandardModelMapping> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "standardmodelmapping664felemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
     ...
     * This is a complex type.
     */
    public interface ActivityHasInternalControlLogic extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.ActivityHasInternalControlLogic> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "activityhasinternalcontrollogice068elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.ActivityHasInternalControlLogic.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtype1366elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
     ...
     * This is a complex type.
     */
    public interface ActivityHasSubActivityActivity extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.ActivityHasSubActivityActivity> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "activityhassubactivityactivityd088elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
         ...
         */
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.ActivityHasSubActivityActivity.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtype45caelemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
     ...
     * This is a complex type.
     */
    public interface ActivityHasStep extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.ActivityHasStep> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "activityhasstepf5e0elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
         ...
         */
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Activity.ActivityHasStep.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtypee4deelemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
