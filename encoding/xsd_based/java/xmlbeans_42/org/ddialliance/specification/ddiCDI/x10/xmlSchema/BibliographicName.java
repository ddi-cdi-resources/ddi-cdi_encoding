...
public interface BibliographicName extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.InternationalString {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.BibliographicName> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "bibliographicname9c68type");
