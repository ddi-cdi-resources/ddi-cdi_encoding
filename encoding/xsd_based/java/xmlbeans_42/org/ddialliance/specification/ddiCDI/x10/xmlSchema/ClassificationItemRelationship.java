...
public interface ClassificationItemRelationship extends org.apache.xmlbeans.XmlObject {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ClassificationItemRelationship> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "classificationitemrelationshipfb8ftype");
     ...
     * This is a complex type.
     */
    public interface ClassificationItemRelationshipHasSourceClassificationItem extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ClassificationItemRelationship.ClassificationItemRelationshipHasSourceClassificationItem> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "classificationitemrelationshiphassourceclassificationitem3272elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
     ...
     * This is a complex type.
     */
    public interface ClassificationItemRelationshipHasTargetClassificationItem extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ClassificationItemRelationship.ClassificationItemRelationshipHasTargetClassificationItem> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "classificationitemrelationshiphastargetclassificationitem87e8elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
