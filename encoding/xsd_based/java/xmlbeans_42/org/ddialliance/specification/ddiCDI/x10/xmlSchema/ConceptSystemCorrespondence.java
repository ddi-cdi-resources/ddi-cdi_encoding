...
public interface ConceptSystemCorrespondence extends org.apache.xmlbeans.XmlObject {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystemCorrespondence> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "conceptsystemcorrespondence7addtype");
     ...
     * This is a complex type.
     */
    public interface ConceptSystemCorrespondenceMapsConceptSystem extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystemCorrespondence.ConceptSystemCorrespondenceMapsConceptSystem> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "conceptsystemcorrespondencemapsconceptsystemfc16elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystemCorrespondence.ConceptSystemCorrespondenceMapsConceptSystem.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtypeb714elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
     ...
     * This is a complex type.
     */
    public interface ConceptSystemCorrespondenceHasConceptMap extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystemCorrespondence.ConceptSystemCorrespondenceHasConceptMap> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "conceptsystemcorrespondencehasconceptmap8c60elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
         ...
         */
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystemCorrespondence.ConceptSystemCorrespondenceHasConceptMap.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtype765eelemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
