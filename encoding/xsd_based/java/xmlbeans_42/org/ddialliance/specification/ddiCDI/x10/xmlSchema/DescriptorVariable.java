...
public interface DescriptorVariable extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.RepresentedVariable {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.DescriptorVariable> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "descriptorvariable2c29type");
     ...
     * This is a complex type.
     */
    public interface DescriptorVariableTakesSubstantiveValuesFromDescriptorValueDomain extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.DescriptorVariable.DescriptorVariableTakesSubstantiveValuesFromDescriptorValueDomain> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "descriptorvariabletakessubstantivevaluesfromdescriptorvaluedomain3eb0elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.DescriptorVariable.DescriptorVariableTakesSubstantiveValuesFromDescriptorValueDomain.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtype6caeelemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
