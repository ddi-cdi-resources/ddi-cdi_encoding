...
public interface DimensionComponent extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.DataStructureComponent {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.DimensionComponent> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "dimensioncomponent9955type");
     ...
     * This is a complex type.
     */
    public interface DimensionComponentIsStructuredByValueDomain extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.DimensionComponent.DimensionComponentIsStructuredByValueDomain> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "dimensioncomponentisstructuredbyvaluedomain22f9elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.DimensionComponent.DimensionComponentIsStructuredByValueDomain.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtypee377elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
