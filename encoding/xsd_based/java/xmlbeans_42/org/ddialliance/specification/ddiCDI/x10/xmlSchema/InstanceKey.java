...
public interface InstanceKey extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Key {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceKey> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "instancekeyc8b6type");
     ...
     * This is a complex type.
     */
    public interface InstanceKeyHasInstanceValue extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceKey.InstanceKeyHasInstanceValue> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "instancekeyhasinstancevalue2ee4elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceKey.InstanceKeyHasInstanceValue.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtypea426elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
     ...
     * This is a complex type.
     */
    public interface InstanceKeyRefersToReferenceValue extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceKey.InstanceKeyRefersToReferenceValue> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "instancekeyreferstoreferencevalue2364elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
         ...
         */
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceKey.InstanceKeyRefersToReferenceValue.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtype1f26elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
