...
public interface ObjectAttributeSelector extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Selector {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ObjectAttributeSelector> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "objectattributeselector02c8type");
