...
public interface ReferenceValue extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceValue {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ReferenceValue> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "referencevalued404type");
     ...
     * This is a complex type.
     */
    public interface ReferenceValueCorrespondsToVariableValueComponent extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ReferenceValue.ReferenceValueCorrespondsToVariableValueComponent> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "referencevaluecorrespondstovariablevaluecomponent9037elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ReferenceValue.ReferenceValueCorrespondsToVariableValueComponent.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtype2935elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
     ...
     * This is a complex type.
     */
    public interface ReferenceValueHasValueFromReferenceValueDomain extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ReferenceValue.ReferenceValueHasValueFromReferenceValueDomain> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "referencevaluehasvaluefromreferencevaluedomainaa99elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
         ...
         */
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.ReferenceValue.ReferenceValueHasValueFromReferenceValueDomain.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s6094410C98087AC10701B450B7C35628.TypeSystemHolder.typeSystem, "validtypee25belemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
