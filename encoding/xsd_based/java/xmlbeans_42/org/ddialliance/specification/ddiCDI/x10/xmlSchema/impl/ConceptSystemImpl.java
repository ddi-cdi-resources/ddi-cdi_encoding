...
public class ConceptSystemImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem.ExternalDefinition getExternalDefinition() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem.ExternalDefinition target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem.ExternalDefinition)get_store().find_element_user(PROPERTY_QNAME[2], 0);
            return (target == null) ? null : target;
        }
    }
     ...
     */
    @Override
    public void setExternalDefinition(org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem.ExternalDefinition externalDefinition) {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem.ExternalDefinition addNewExternalDefinition() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem.ExternalDefinition target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem.ExternalDefinition)get_store().add_element_user(PROPERTY_QNAME[2]);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class ExternalDefinitionImpl extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.impl.ReferenceImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem.ExternalDefinition {
        private static final long serialVersionUID = 1L;

        public ExternalDefinitionImpl(org.apache.xmlbeans.SchemaType sType) {
            super(sType);
        }
     ...
     * This is a complex type.
     */
    public static class ConceptSystemIsDefinedByConceptImpl extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.impl.ReferenceImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem.ConceptSystemIsDefinedByConcept {
        private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class ConceptSystemHasConceptImpl extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.impl.ReferenceImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptSystem.ConceptSystemHasConcept {
        private static final long serialVersionUID = 1L;
