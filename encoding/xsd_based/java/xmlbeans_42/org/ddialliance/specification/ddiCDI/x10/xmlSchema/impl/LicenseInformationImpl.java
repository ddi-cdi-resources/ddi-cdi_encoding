...
public class LicenseInformationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation {
     ...
     */
    @Override
    public java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference> getLicenseReferenceList() {
        synchronized (monitor()) {
            check_orphaned();
            return new org.apache.xmlbeans.impl.values.JavaListXmlObject<>(
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference[] getLicenseReferenceArray() {
        return getXmlObjectArray(PROPERTY_QNAME[3], new org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference[0]);
    }
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference getLicenseReferenceArray(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference)get_store().find_element_user(PROPERTY_QNAME[3], i);
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
     ...
     */
    @Override
    public void setLicenseReferenceArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference[] licenseReferenceArray) {
        check_orphaned();
     ...
     */
    @Override
    public void setLicenseReferenceArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference licenseReference) {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference insertNewLicenseReference(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference)get_store().insert_element_user(PROPERTY_QNAME[3], i);
            return target;
        }
    }
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference addNewLicenseReference() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference)get_store().add_element_user(PROPERTY_QNAME[3]);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class LicenseReferenceImpl extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.impl.ReferenceImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.LicenseInformation.LicenseReference {
        private static final long serialVersionUID = 1L;

        public LicenseReferenceImpl(org.apache.xmlbeans.SchemaType sType) {
            super(sType);
        }
