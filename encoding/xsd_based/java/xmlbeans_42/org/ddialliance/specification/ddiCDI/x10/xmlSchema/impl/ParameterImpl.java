...
public class ParameterImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter {
     ...
     */
    @Override
    public java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound> getEntityBoundList() {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound[] getEntityBoundArray() {
        return getXmlObjectArray(PROPERTY_QNAME[0], new org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound[0]);
    }
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound getEntityBoundArray(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound)get_store().find_element_user(PROPERTY_QNAME[0], i);
            if (target == null) {
     ...
     */
    @Override
    public void setEntityBoundArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound[] entityBoundArray) {
        check_orphaned();
     ...
     */
    @Override
    public void setEntityBoundArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound entityBound) {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound insertNewEntityBound(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound)get_store().insert_element_user(PROPERTY_QNAME[0], i);
            return target;
        }
    }
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound addNewEntityBound() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound)get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class EntityBoundImpl extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.impl.ReferenceImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.Parameter.EntityBound {
        private static final long serialVersionUID = 1L;

        public EntityBoundImpl(org.apache.xmlbeans.SchemaType sType) {
            super(sType);
        }
