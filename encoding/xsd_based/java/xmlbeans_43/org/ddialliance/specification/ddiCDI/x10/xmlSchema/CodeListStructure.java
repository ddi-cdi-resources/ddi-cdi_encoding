 ...
 */
public interface CodeListStructure extends org.apache.xmlbeans.XmlObject {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "codeliststructured674type");
     ...
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureStructuresCodeList getCodeListStructureStructuresCodeList();

    /**
     * True if has "CodeListStructure_structures_CodeList" element
     */
    boolean isSetCodeListStructureStructuresCodeList();

    /**
     * Sets the "CodeListStructure_structures_CodeList" element
     */
    void setCodeListStructureStructuresCodeList(org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureStructuresCodeList codeListStructureStructuresCodeList);

    /**
     * Appends and returns a new empty "CodeListStructure_structures_CodeList" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureStructuresCodeList addNewCodeListStructureStructuresCodeList();

    /**
     * Unsets the "CodeListStructure_structures_CodeList" element
     */
    void unsetCodeListStructureStructuresCodeList();

    /**
     * Gets a List of "CodeListStructure_has_CodeRelationship" elements
     */
    java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureHasCodeRelationship> getCodeListStructureHasCodeRelationshipList();

    /**
     * Gets array of all "CodeListStructure_has_CodeRelationship" elements
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureHasCodeRelationship[] getCodeListStructureHasCodeRelationshipArray();

    /**
     * Gets ith "CodeListStructure_has_CodeRelationship" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureHasCodeRelationship getCodeListStructureHasCodeRelationshipArray(int i);

    /**
     * Returns number of "CodeListStructure_has_CodeRelationship" element
     */
    int sizeOfCodeListStructureHasCodeRelationshipArray();

    /**
     * Sets array of all "CodeListStructure_has_CodeRelationship" element
     */
    void setCodeListStructureHasCodeRelationshipArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureHasCodeRelationship[] codeListStructureHasCodeRelationshipArray);

    /**
     * Sets ith "CodeListStructure_has_CodeRelationship" element
     */
    void setCodeListStructureHasCodeRelationshipArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureHasCodeRelationship codeListStructureHasCodeRelationship);

    /**
     * Inserts and returns a new empty value (as xml) as the ith "CodeListStructure_has_CodeRelationship" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureHasCodeRelationship insertNewCodeListStructureHasCodeRelationship(int i);

    /**
     * Appends and returns a new empty value (as xml) as the last "CodeListStructure_has_CodeRelationship" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureHasCodeRelationship addNewCodeListStructureHasCodeRelationship();

    /**
     * Removes the ith "CodeListStructure_has_CodeRelationship" element
     */
    void removeCodeListStructureHasCodeRelationship(int i);
     ...
     * This is a complex type.
     */
    public interface CodeListStructureStructuresCodeList extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.AssociationReference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureStructuresCodeList> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "codeliststructurestructurescodelist2dd3elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureStructuresCodeList.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "validtype4795elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
            ...
            /**
             * Enumeration value class for org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure$CodeListStructureStructuresCodeList$ValidType.
     ...
     * This is a complex type.
     */
    public interface CodeListStructureHasCodeRelationship extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.AssociationReference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureHasCodeRelationship> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "codeliststructurehascoderelationship9571elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
         ...
         */
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure.CodeListStructureHasCodeRelationship.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "validtypeb3efelemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
            ...
            Enum CODE_RELATIONSHIP = Enum.forString("CodeRelationship");

            int INT_CODE_RELATIONSHIP = Enum.INT_CODE_RELATIONSHIP;

            /**
             * Enumeration value class for org.ddialliance.specification.ddiCDI.x10.xmlSchema.CodeListStructure$CodeListStructureHasCodeRelationship$ValidType.
             * These enum values can be used as follows:
             * <pre>
             * enum.toString(); // returns the string value of the enum
             * enum.intValue(); // returns an int value, useful for switches
             * // e.g., case Enum.INT_CODE_RELATIONSHIP
             * Enum.forString(s); // returns the enum value for a string
             * Enum.forInt(i); // returns the enum value for an int
             * </pre>
             * Enumeration objects are immutable singleton objects that
            ...
            final class Enum extends org.apache.xmlbeans.StringEnumAbstractBase {
                ...
                static final int INT_CODE_RELATIONSHIP = 1;

                public static final org.apache.xmlbeans.StringEnumAbstractBase.Table table =
                    new org.apache.xmlbeans.StringEnumAbstractBase.Table(new Enum[] {
                    new Enum("CodeRelationship", INT_CODE_RELATIONSHIP),
                });
                private static final long serialVersionUID = 1L;
                private java.lang.Object readResolve() {
                    return forInt(intValue());
