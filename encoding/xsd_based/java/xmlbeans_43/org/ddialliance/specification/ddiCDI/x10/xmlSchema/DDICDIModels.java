 ...
 */
public interface DDICDIModels extends org.apache.xmlbeans.XmlObject {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.DDICDIModels> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "ddicdimodels35a7type");
     ...
     */
    java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Wrapper> getWrapperList();

    /**
     * Gets array of all "Wrapper" elements
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Wrapper[] getWrapperArray();

    /**
     * Gets ith "Wrapper" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Wrapper getWrapperArray(int i);

    /**
     * Returns number of "Wrapper" element
     */
    int sizeOfWrapperArray();

    /**
     * Sets array of all "Wrapper" element
     */
    void setWrapperArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.Wrapper[] wrapperArray);

    /**
     * Sets ith "Wrapper" element
     */
    void setWrapperArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.Wrapper wrapper);

    /**
     * Inserts and returns a new empty value (as xml) as the ith "Wrapper" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Wrapper insertNewWrapper(int i);
