...
public interface DimensionComponent extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.DataStructureComponent {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.DimensionComponent> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "dimensioncomponent9955type");
    ...
    public interface DimensionComponentIsStructuredByValueDomain extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.AssociationReference {
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.DimensionComponent.DimensionComponentIsStructuredByValueDomain.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "validtypee377elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
