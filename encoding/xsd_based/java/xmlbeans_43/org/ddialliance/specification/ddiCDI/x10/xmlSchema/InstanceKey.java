...
public interface InstanceKey extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Key {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceKey> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "instancekeyc8b6type");
    ...
    public interface InstanceKeyHasInstanceValue extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.AssociationReference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceKey.InstanceKeyHasInstanceValue> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "instancekeyhasinstancevalue2ee4elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceKey.InstanceKeyHasInstanceValue.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "validtypea426elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
    ...
    public interface InstanceKeyRefersToReferenceValue extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.AssociationReference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceKey.InstanceKeyRefersToReferenceValue> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "instancekeyreferstoreferencevalue2364elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
         ...
         */
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceKey.InstanceKeyRefersToReferenceValue.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "validtype1f26elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
