...
public interface KeyMember extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceValue {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.KeyMember> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "keymember7e45type");
    ...
    public interface KeyMemberIsBasedOnDataStructureComponent extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.AssociationReference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.KeyMember.KeyMemberIsBasedOnDataStructureComponent> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "keymemberisbasedondatastructurecomponent1992elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.KeyMember.KeyMemberIsBasedOnDataStructureComponent.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "validtype2710elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
