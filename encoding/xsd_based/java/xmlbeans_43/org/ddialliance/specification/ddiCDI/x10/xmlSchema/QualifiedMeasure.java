...
public interface QualifiedMeasure extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.MeasureComponent {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.QualifiedMeasure> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "qualifiedmeasure3000type");
    ...
    public interface QualifiedMeasureRefinesMeasureComponent extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.AssociationReference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.QualifiedMeasure.QualifiedMeasureRefinesMeasureComponent> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "qualifiedmeasurerefinesmeasurecomponentda3felemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.QualifiedMeasure.QualifiedMeasureRefinesMeasureComponent.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "validtype513delemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
