...
public interface RepresentedVariable extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.ConceptualVariable {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.RepresentedVariable> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "representedvariable3e0ftype");
    ...
    public interface RepresentedVariableTakesSubstantiveValuesFromSubstantiveValueDomain extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.AssociationReference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.RepresentedVariable.RepresentedVariableTakesSubstantiveValuesFromSubstantiveValueDomain> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "representedvariabletakessubstantivevaluesfromsubstantivevaluedomainc2afelemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
         ...
         */
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.RepresentedVariable.RepresentedVariableTakesSubstantiveValuesFromSubstantiveValueDomain.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s65F2E4CDA8D692346164D243434CB4E1.TypeSystemHolder.typeSystem, "validtypeebf1elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
