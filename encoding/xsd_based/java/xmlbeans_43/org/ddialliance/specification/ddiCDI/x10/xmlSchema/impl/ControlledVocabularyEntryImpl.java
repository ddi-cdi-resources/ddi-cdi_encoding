...
public class ControlledVocabularyEntryImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.ControlledVocabularyEntry {
     ...
     */
    @Override
    public java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference> getEntryReferenceList() {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference[] getEntryReferenceArray() {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference getEntryReferenceArray(int i) {
        synchronized (monitor()) {
            check_orphaned();
     ...
     */
    @Override
    public void setEntryReferenceArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference[] entryReferenceArray) {
        check_orphaned();
     ...
     */
    @Override
    public void setEntryReferenceArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference entryReference) {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference insertNewEntryReference(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference target = null;
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference addNewEntryReference() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference target = null;
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference getVocabulary() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference)get_store().find_element_user(PROPERTY_QNAME[4], 0);
     ...
     */
    @Override
    public void setVocabulary(org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference vocabulary) {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference addNewVocabulary() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference target = null;
