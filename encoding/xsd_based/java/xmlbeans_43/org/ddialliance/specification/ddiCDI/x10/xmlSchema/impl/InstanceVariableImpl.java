...
public class InstanceVariableImpl extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.impl.RepresentedVariableImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.InstanceVariable {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference getSource() {
        synchronized (monitor()) {
            check_orphaned();
     ...
     */
    @Override
    public void setSource(org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference source) {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference addNewSource() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference target = null;
