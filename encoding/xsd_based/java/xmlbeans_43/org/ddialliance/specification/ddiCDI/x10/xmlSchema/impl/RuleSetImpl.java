 ...
 */
public class RuleSetImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet {
    ...
    private static final QName[] PROPERTY_QNAME = {
        ...
        new QName("http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/", "RuleSet_has_Rule"),
    };
     ...
     */
    @Override
    public java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule> getRuleSetHasRuleList() {
        synchronized (monitor()) {
            check_orphaned();
            return new org.apache.xmlbeans.impl.values.JavaListXmlObject<>(
                this::getRuleSetHasRuleArray,
                this::setRuleSetHasRuleArray,
                this::insertNewRuleSetHasRule,
                this::removeRuleSetHasRule,
                this::sizeOfRuleSetHasRuleArray
            );
        }
    }
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule[] getRuleSetHasRuleArray() {
        return getXmlObjectArray(PROPERTY_QNAME[1], new org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule[0]);
    }
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule getRuleSetHasRuleArray(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule)get_store().find_element_user(PROPERTY_QNAME[1], i);
            if (target == null) {
     ...
     */
    @Override
    public int sizeOfRuleSetHasRuleArray() {
        synchronized (monitor()) {
            check_orphaned();
    ...
    /**
     * Sets array of all "RuleSet_has_Rule" element  WARNING: This method is not atomicaly synchronized.
     */
    @Override
    public void setRuleSetHasRuleArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule[] ruleSetHasRuleArray) {
        check_orphaned();
        arraySetterHelper(ruleSetHasRuleArray, PROPERTY_QNAME[1]);
    }
     ...
     */
    @Override
    public void setRuleSetHasRuleArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule ruleSetHasRule) {
        generatedSetterHelperImpl(ruleSetHasRule, PROPERTY_QNAME[1], i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule insertNewRuleSetHasRule(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule)get_store().insert_element_user(PROPERTY_QNAME[1], i);
            return target;
        }
    }
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule addNewRuleSetHasRule() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule)get_store().add_element_user(PROPERTY_QNAME[1]);
            return target;
        }
    }
     ...
     */
    @Override
    public void removeRuleSetHasRule(int i) {
        synchronized (monitor()) {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class RuleSetHasRuleImpl extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.impl.AssociationReferenceImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule {
        private static final long serialVersionUID = 1L;

        public RuleSetHasRuleImpl(org.apache.xmlbeans.SchemaType sType) {
            super(sType);
        }
         ...
         */
        public static class ValidTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.RuleSet.RuleSetHasRule.ValidType {
            private static final long serialVersionUID = 1L;
