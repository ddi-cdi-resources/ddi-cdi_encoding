...
public interface CatalogDetails extends org.apache.xmlbeans.XmlObject {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.CatalogDetails> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s8FD33996D15E73B19F7AD902AE837DDC.TypeSystemHolder.typeSystem, "catalogdetails8887type");
     ...
     */
    java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference> getRelatedResourceList();

    /**
     * Gets array of all "relatedResource" elements
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference[] getRelatedResourceArray();

    /**
     * Gets ith "relatedResource" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference getRelatedResourceArray(int i);
     ...
     */
    void setRelatedResourceArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference[] relatedResourceArray);

    /**
     * Sets ith "relatedResource" element
     */
    void setRelatedResourceArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference relatedResource);

    /**
     * Inserts and returns a new empty value (as xml) as the ith "relatedResource" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference insertNewRelatedResource(int i);

    /**
     * Appends and returns a new empty value (as xml) as the last "relatedResource" element
     */
    org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference addNewRelatedResource();
