...
public interface Population extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.Universe {
    DocumentFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Population> Factory = new DocumentFactory<>(org.apache.xmlbeans.metadata.system.s8FD33996D15E73B19F7AD902AE837DDC.TypeSystemHolder.typeSystem, "population2e6btype");
    ...
    public interface PopulationIsComposedOfUnit extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.AssociationReference {
        ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Population.PopulationIsComposedOfUnit> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s8FD33996D15E73B19F7AD902AE837DDC.TypeSystemHolder.typeSystem, "populationiscomposedofunit8051elemtype");
        org.apache.xmlbeans.SchemaType type = Factory.getType();
        ...
        public interface ValidType extends org.apache.xmlbeans.XmlNMTOKEN {
            ElementFactory<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Population.PopulationIsComposedOfUnit.ValidType> Factory = new ElementFactory<>(org.apache.xmlbeans.metadata.system.s8FD33996D15E73B19F7AD902AE837DDC.TypeSystemHolder.typeSystem, "validtype5e13elemtype");
            org.apache.xmlbeans.SchemaType type = Factory.getType();
