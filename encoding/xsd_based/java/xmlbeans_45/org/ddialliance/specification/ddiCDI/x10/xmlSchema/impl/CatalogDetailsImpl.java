...
public class CatalogDetailsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.CatalogDetails {
     ...
     */
    @Override
    public java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference> getRelatedResourceList() {
        synchronized (monitor()) {
            check_orphaned();
            return new org.apache.xmlbeans.impl.values.JavaListXmlObject<>(
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference[] getRelatedResourceArray() {
        return getXmlObjectArray(PROPERTY_QNAME[10], new org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference[0]);
    }
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference getRelatedResourceArray(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference)get_store().find_element_user(PROPERTY_QNAME[10], i);
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
     ...
     */
    @Override
    public void setRelatedResourceArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference[] relatedResourceArray) {
        check_orphaned();
     ...
     */
    @Override
    public void setRelatedResourceArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference relatedResource) {
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference insertNewRelatedResource(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference)get_store().insert_element_user(PROPERTY_QNAME[10], i);
            return target;
        }
    }
     ...
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference addNewRelatedResource() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.Reference)get_store().add_element_user(PROPERTY_QNAME[10]);
            return target;
        }
    }
