/*
 * XML Type:  CategoryRelationStructure
 * Namespace: http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/
 * Java type: org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure
 *
...
/**
 * An XML CategoryRelationStructure(@http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/).
 *
 * This is a complex type.
 */
public class CategoryRelationStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure {
    private static final long serialVersionUID = 1L;

    public CategoryRelationStructureImpl(org.apache.xmlbeans.SchemaType sType) {
        super(sType);
    }
    ...
    private static final QName[] PROPERTY_QNAME = {
        ...
        new QName("http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/", "CategoryRelationStructure_structures_CategorySet"),
        new QName("http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/", "CategoryRelationStructure_has_CategoryRelationship"),
    };
    ...
    /**
     * Gets the "CategoryRelationStructure_structures_CategorySet" element
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureStructuresCategorySet getCategoryRelationStructureStructuresCategorySet() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureStructuresCategorySet target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureStructuresCategorySet)get_store().find_element_user(PROPERTY_QNAME[7], 0);
            return (target == null) ? null : target;
        }
    }

    /**
     * True if has "CategoryRelationStructure_structures_CategorySet" element
     */
    @Override
    public boolean isSetCategoryRelationStructureStructuresCategorySet() {
        synchronized (monitor()) {
            check_orphaned();
    ...
    /**
     * Sets the "CategoryRelationStructure_structures_CategorySet" element
     */
    @Override
    public void setCategoryRelationStructureStructuresCategorySet(org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureStructuresCategorySet categoryRelationStructureStructuresCategorySet) {
        generatedSetterHelperImpl(categoryRelationStructureStructuresCategorySet, PROPERTY_QNAME[7], 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }

    /**
     * Appends and returns a new empty "CategoryRelationStructure_structures_CategorySet" element
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureStructuresCategorySet addNewCategoryRelationStructureStructuresCategorySet() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureStructuresCategorySet target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureStructuresCategorySet)get_store().add_element_user(PROPERTY_QNAME[7]);
            return target;
        }
    }

    /**
     * Unsets the "CategoryRelationStructure_structures_CategorySet" element
     */
    @Override
    public void unsetCategoryRelationStructureStructuresCategorySet() {
        synchronized (monitor()) {
            check_orphaned();
    ...
    /**
     * Gets a List of "CategoryRelationStructure_has_CategoryRelationship" elements
     */
    @Override
    public java.util.List<org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship> getCategoryRelationStructureHasCategoryRelationshipList() {
        synchronized (monitor()) {
            check_orphaned();
            return new org.apache.xmlbeans.impl.values.JavaListXmlObject<>(
                this::getCategoryRelationStructureHasCategoryRelationshipArray,
                this::setCategoryRelationStructureHasCategoryRelationshipArray,
                this::insertNewCategoryRelationStructureHasCategoryRelationship,
                this::removeCategoryRelationStructureHasCategoryRelationship,
                this::sizeOfCategoryRelationStructureHasCategoryRelationshipArray
            );
        }
    }

    /**
     * Gets array of all "CategoryRelationStructure_has_CategoryRelationship" elements
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship[] getCategoryRelationStructureHasCategoryRelationshipArray() {
        return getXmlObjectArray(PROPERTY_QNAME[8], new org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship[0]);
    }

    /**
     * Gets ith "CategoryRelationStructure_has_CategoryRelationship" element
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship getCategoryRelationStructureHasCategoryRelationshipArray(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship)get_store().find_element_user(PROPERTY_QNAME[8], i);
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
    ...
    /**
     * Returns number of "CategoryRelationStructure_has_CategoryRelationship" element
     */
    @Override
    public int sizeOfCategoryRelationStructureHasCategoryRelationshipArray() {
        synchronized (monitor()) {
            check_orphaned();
    ...
    /**
     * Sets array of all "CategoryRelationStructure_has_CategoryRelationship" element  WARNING: This method is not atomicaly synchronized.
     */
    @Override
    public void setCategoryRelationStructureHasCategoryRelationshipArray(org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship[] categoryRelationStructureHasCategoryRelationshipArray) {
        check_orphaned();
        arraySetterHelper(categoryRelationStructureHasCategoryRelationshipArray, PROPERTY_QNAME[8]);
    }

    /**
     * Sets ith "CategoryRelationStructure_has_CategoryRelationship" element
     */
    @Override
    public void setCategoryRelationStructureHasCategoryRelationshipArray(int i, org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship categoryRelationStructureHasCategoryRelationship) {
        generatedSetterHelperImpl(categoryRelationStructureHasCategoryRelationship, PROPERTY_QNAME[8], i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }

    /**
     * Inserts and returns a new empty value (as xml) as the ith "CategoryRelationStructure_has_CategoryRelationship" element
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship insertNewCategoryRelationStructureHasCategoryRelationship(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship)get_store().insert_element_user(PROPERTY_QNAME[8], i);
            return target;
        }
    }

    /**
     * Appends and returns a new empty value (as xml) as the last "CategoryRelationStructure_has_CategoryRelationship" element
     */
    @Override
    public org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship addNewCategoryRelationStructureHasCategoryRelationship() {
        synchronized (monitor()) {
            check_orphaned();
            org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship target = null;
            target = (org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship)get_store().add_element_user(PROPERTY_QNAME[8]);
            return target;
        }
    }

    /**
     * Removes the ith "CategoryRelationStructure_has_CategoryRelationship" element
     */
    @Override
    public void removeCategoryRelationStructureHasCategoryRelationship(int i) {
        synchronized (monitor()) {
            check_orphaned();
    ...
    /**
     * An XML CategoryRelationStructure_structures_CategorySet(@http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/).
     *
     * This is a complex type.
     */
    public static class CategoryRelationStructureStructuresCategorySetImpl extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.impl.AssociationReferenceImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureStructuresCategorySet {
        private static final long serialVersionUID = 1L;

        public CategoryRelationStructureStructuresCategorySetImpl(org.apache.xmlbeans.SchemaType sType) {
            super(sType);
        }
        /**
         * An XML validType(@http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/).
         *
         * This is an atomic type that is a restriction of org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure$CategoryRelationStructureStructuresCategorySet$ValidType.
         */
        public static class ValidTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureStructuresCategorySet.ValidType {
            private static final long serialVersionUID = 1L;
    ...
    /**
     * An XML CategoryRelationStructure_has_CategoryRelationship(@http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/).
     *
     * This is a complex type.
     */
    public static class CategoryRelationStructureHasCategoryRelationshipImpl extends org.ddialliance.specification.ddiCDI.x10.xmlSchema.impl.AssociationReferenceImpl implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship {
        private static final long serialVersionUID = 1L;

        public CategoryRelationStructureHasCategoryRelationshipImpl(org.apache.xmlbeans.SchemaType sType) {
            super(sType);
        }
         ...
         * An XML validType(@http://ddialliance.org/Specification/DDI-CDI/1.0/XMLSchema/).
         *
         * This is an atomic type that is a restriction of org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure$CategoryRelationStructureHasCategoryRelationship$ValidType.
         */
        public static class ValidTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.ddialliance.specification.ddiCDI.x10.xmlSchema.CategoryRelationStructure.CategoryRelationStructureHasCategoryRelationship.ValidType {
            private static final long serialVersionUID = 1L;
